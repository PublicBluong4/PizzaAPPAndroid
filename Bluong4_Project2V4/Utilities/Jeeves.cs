...
namespace Bluong4_Project2V4.Utilities
{
    public static class Jeeves
    {
        //Local WebApi
        //public static Uri DBUri = new Uri("http://localhost:52404/");
        //WebApi on Azure
        public static Uri DBUri = new Uri("https://bluong4apiproject2v6.azurewebsites.net/");
